...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $stmt = $pdo->prepare("INSERT INTO recipes (user_id, title, description, ingredients, steps, image_url) VALUES (?, ?, ?, ?, ?, ?)");
  $success = $stmt->execute([$user_id, $title, $description, $ingredients, $steps, $image_url]);
...
<body>
  <div class="container">
    ...
    <form method="POST" action="add_recipe.php" enctype="multipart/form-data">
      ...
      <button class="btn-submit" type="submit">Add Recipe</button>
    </form>
  </div>
</body>
